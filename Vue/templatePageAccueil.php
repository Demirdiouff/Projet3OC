...
<link href="Contenu/stylePageAccueil.css" rel="stylesheet">
            ...
            <div class="inner">
              ...
              <nav>
                <ul class="nav masthead-nav">
                  ...
                  <li><a href="index.php?action=pagePropos">A propos</a></li>
                  <li><a href="index.php?action=pageRoman">Roman</a></li>
                  <li><a href="index.php?action=pageContact">Contact</a></li>
                </ul>
              </nav>
            </div>
          </div>
