	...
	<div class="row">
		<div class="col-sm-8 blog-main">
		  ...
		  <?php foreach ($commentaires as $commentaire): ?>
			...
			<p style="font-size: 10px;"><a href="index.php?action=signalementCommentaire&idCommentaire=<?= $commentaire->id() ?>&idPost=<?= $post->id()?>&titrePost=<?= $post->titrePost()?>">Signaler</a></p>
			<hr id="hr-foreach">
